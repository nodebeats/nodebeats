...
var imageGalleryController = function(){
    ...
    _p.updateCoverImage = function(req, res, next){
        ...
        dataProviderHelper.updateEmbeddedDocument(ImageGallery, resetCoverImageQuery, { 'image.$.coverImage' : false })
            .then(function(){
                return dataProviderHelper.updateEmbeddedDocument(ImageGallery, updateCoverImageQuery, updateCoverImgOpts);
            })
            .then(function(){
                res.status(HTTPStatus.OK);
                res.json({
    ...
    _p.updateGalleryImageInfo = function (req,res, next) {
        ...
        if(imageInfo._imageName){
            ...
            dataProviderHelper.updateEmbeddedDocument(ImageGallery, query, newImage)
                .then(function(){
                    res.status(HTTPStatus.OK);
                    res.json({
