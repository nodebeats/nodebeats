(function (pageViewController) {
    ...
    var Promise = require('bluebird'),
        join = Promise.join,
        applilcationConfig = require('../../configs/application.config'),
            ...
            return join(
                ...
                function (commonData, imageGalleryData, cloudinaryData) {
                    return {
                        ...
                        cloudinaryCloudName: (cloudinaryData === null ? applilcationConfig.cloudinary.defaultCloudName : cloudinaryData.cloudinaryCloudName)
                    };
                });
        };
