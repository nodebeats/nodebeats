...
var newsController = function () {
    ...
    _p.updateNewsImageInfo = function (req, res, next) {
        ...
        if (imageInfo._imageName) {
            ...
            dataProviderHelper.updateEmbeddedDocument(NewsImage, updateQueryOpts, newsImageSchema)
                .then(function () {
                    res.status(HTTPStatus.OK);
                    res.json({
        ...
        if (req.body._id !== req.newsImageInfo._id) {
            ...
            dataProviderHelper.save(req.newsImageInfo)
                .then(function () {
                    ...
                    return dataProviderHelper.updateEmbeddedDocument(NewsImage, updateQueryOpts, newsImageSchema);
                })
                .then(function () {
                    res.status(HTTPStatus.OK);
                    res.json({
