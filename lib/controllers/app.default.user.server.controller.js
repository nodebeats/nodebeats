...
var defaultUserStatusController = function(){
    ...
    _p.getDefaultUserStatus = function(req, res){
        ...
        dataProviderHelper.findOne(DefaultUserStatus, {}, '')
            ...
            .then(function () {
                console.log(messageConfig.defaultApp.successMessage);
            })
            .catch(Promise.CancellationError, function () {
                console.log(messageConfig.defaultApp.alreadyExists);
            })
            .catch(function () {
                console.log(messageConfig.defaultApp.failureMessage);
            });
    };
