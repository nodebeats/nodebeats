...
(function (securityConfigure) {
    ...
    securityConfigure.init = function (app) {
        ...
        app.use(helmet.contentSecurityPolicy({
            ...
            directives: {
                defaultSrc: ["'self'"],
                scriptSrc: ["'self'","unsafe-eval","unsafe-inline","www.google-analytics.com/","https://apis.google.com/", "'unsafe-inline'", "'unsafe-eval'", "www.google-analytics.com", "ajax.googleapis.com"],
