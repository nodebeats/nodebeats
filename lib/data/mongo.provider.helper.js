...
(function(providerHelper){
    ...
    providerHelper.getAllEmbeddedDocumentsWithoutDocumentFieldsNoPagination = function(Model, queryOpts){
        return Model
            .find(queryOpts)
            .execAsync();
    };
    ...
    providerHelper.updateEmbeddedDocument = function(Model, queryOpts, newModelInfo){
        return Model.update( queryOpts, newModelInfo)
            .execAsync();
    };
