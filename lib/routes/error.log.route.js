...
var errorLogRoutes = function () {
     ...
     */
        ...
        .get( tokenAuthMiddleware.authenticate,  getErrorLogs );
     ...
     */
        ...
        .put(tokenAuthMiddleware.authenticate, errorLogController.deleteErrorLog);
     ...
     */
        ...
        .put(tokenAuthMiddleware.authenticate, deleteAllErrorLogs);
     ...
     */
        ...
        .put(tokenAuthMiddleware.authenticate, errorLogController.sendNotificationEmailToSolveErrors);
