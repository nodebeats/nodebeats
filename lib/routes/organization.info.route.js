 ...
 *     }
     ...
     */
        ...
        .post( tokenAuthMiddleware.authenticate, uploader.single('imageName'), fileUploadHelper.imageUpload, organizationInformationController.postOrganizationInfo );
 ...
 *     }
         *
         */
        .put( tokenAuthMiddleware.authenticate, uploader.single('imageName'), fileUploadHelper.imageUpload, organizationInformationController.updateOrganizationInfo );
