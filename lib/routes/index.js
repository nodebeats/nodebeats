...
(function (appllicationRoutes) {
    ...
    appllicationRoutes.init = function (app) {
        ...
        app.delete('/api/deletefile', tokenAuthMiddleware.authenticate, fileOperationHelper.deleteFile);
        ...
        app.use('/api/cloudinary', tokenAuthMiddleware.authenticate, cloudinarySettingRouter);
