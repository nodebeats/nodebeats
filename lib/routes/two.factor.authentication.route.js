...
var twoFactorAuthRoutes = function () {
     ...
     */
        ...
        .get(tokenAuthMiddleware.authenticate, getTOTPSecret);
     ...
     */
        ...
        .put(tokenAuthMiddleware.authenticate, userController.disableTwoFactorAuthentication);
     ...
     */
        ...
        .post(tokenAuthMiddleware.authenticate, verifyTOTPSecret);
