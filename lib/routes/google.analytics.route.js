...
var googleAnalyticsRoutes = function () {
    ...
    *     }
     ...
     *
     */
        .get( tokenAuthMiddleware.authenticate, getGoogleAnalyticsConfig )
        ...
        * }
        ...
        .post(tokenAuthMiddleware.authenticate, documentUploader.single('documentName'), googleAnalyticsController.postGoogleAnalyticsConfig);
    ...
    googleAnalyticsRouter.use('/:googleAnalyticsConfigId', tokenAuthMiddleware.authenticate, function (req, res, next) {
     ...
     */
        ...
        .put(tokenAuthMiddleware.authenticate, documentUploader.single('documentName'),  googleAnalyticsController.updateGoogleAnalyticsConfig);
