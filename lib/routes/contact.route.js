 ...
 *     }
     *
     */
        .get( tokenAuthMiddleware.authenticate, getContactList)
 ...
 *     }
    ...
    contactInfoRouter.use('/:contactId', tokenAuthMiddleware.authenticate, function(req, res, next){
 ...
 *     }
         *
         */
        .patch( tokenAuthMiddleware.authenticate, contactInfoController.patchContactInfo );
