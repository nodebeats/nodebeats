...
var newsRoutes = function () {
     ...
     */
        ...
        .post(tokenAuthMiddleware.authenticate, newsController.postNewsCategory);
     ...
     */
        ...
        .patch(tokenAuthMiddleware.authenticate, newsController.patchNewsCategory)
        ...
        .put(tokenAuthMiddleware.authenticate, newsController.updateNewsCategory);
     ...
     */
        ...
        .post(tokenAuthMiddleware.authenticate, uploader.single('imageName'), fileUploadHelper.imageUpload, newsController.postNews);
     ...
     */
        ...
        .patch(tokenAuthMiddleware.authenticate, newsController.patchNews)
        ...
        .put(tokenAuthMiddleware.authenticate, uploader.single('imageName'), fileUploadHelper.imageUpload, newsController.updateNews);
     ...
     */
        ...
        .post(tokenAuthMiddleware.authenticate, uploader.single('imageName'), fileUploadHelper.imageUpload, newsController.postNewsImageInfo);
     ...
     */
        ...
        .delete(tokenAuthMiddleware.authenticate, newsController.removeNewsImage)
        ...
        .patch(tokenAuthMiddleware.authenticate, newsController.updateCoverImage)
        ...
        .put(tokenAuthMiddleware.authenticate, uploader.single('imageName'), fileUploadHelper.imageUpload, newsController.updateNewsImageInfo);
