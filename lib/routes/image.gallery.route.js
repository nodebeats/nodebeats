...
var imageGalleryRoutes = function(){
     ...
     */
        ...
        .post( tokenAuthMiddleware.authenticate, imageGalleryController.postAlbumInfo );
     ...
     *     }
        ...
        .patch( tokenAuthMiddleware.authenticate, imageGalleryController.patchGalleryAlbum )
     ...
     *     }
        ...
        .put( tokenAuthMiddleware.authenticate, imageGalleryController.updateAlbumInfo );
     ...
     */
        ...
        .post( tokenAuthMiddleware.authenticate, uploader.single('imageName'), fileUploadHelper.imageUpload, imageGalleryController.postGalleryImageInfo );
     ...
     */
        ...
        .delete( tokenAuthMiddleware.authenticate, imageGalleryController.removeImage )
        ...
        .patch( tokenAuthMiddleware.authenticate, imageGalleryController.updateCoverImage )
        ...
        .put( tokenAuthMiddleware.authenticate, uploader.single('imageName'), fileUploadHelper.imageUpload, imageGalleryController.updateGalleryImageInfo );
