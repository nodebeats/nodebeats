...
var emailTemplateRoutes = function () {
     ...
     */
         ...
         *
         */
        .post(tokenAuthMiddleware.authenticate, emailTemplateController.postEmailTemplate);
     ...
     */
         ...
         *
         */
        .patch(tokenAuthMiddleware.authenticate, emailTemplateController.patchEmailTemplateData)
         ...
         *
         */
        .put(tokenAuthMiddleware.authenticate, emailTemplateController.updateEmailTemplateData);
