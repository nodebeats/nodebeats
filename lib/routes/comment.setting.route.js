...
var commentSettingRoutes = function () {
     ...
     */
        ...
        .post( tokenAuthMiddleware.authenticate, commentSettingController.postCommentSetting );
    ...
    commentSettingRouter.use('/:commentSettingId', tokenAuthMiddleware.authenticate,  function(req, res, next){
     ...
     */
        ...
        .put( tokenAuthMiddleware.authenticate,  commentSettingController.updateCommentSetting );
