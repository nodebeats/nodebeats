 ...
 *     }
         *
         */
        .post( tokenAuthMiddleware.authenticate, uploader.single('imageName'), fileUploadHelper.imageUpload, imageSliderController.postSliderImage );
 ...
 *     }
         *
         */
        .patch( tokenAuthMiddleware.authenticate, imageSliderController.patchSliderImage )
 ...
 *     }
         *
         */
        .put( tokenAuthMiddleware.authenticate, uploader.single('imageName'), fileUploadHelper.imageUpload, imageSliderController.updateSliderImage );
