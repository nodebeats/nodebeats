...
var htmlModuleRoutes = function(){
     ...
     */
        ...
        .post( tokenAuthMiddleware.authenticate, htmlModuleController.postHtmlContent );
...
//middleware function that will get the html content data object for each of the routes defined downwards having /api/htmlcontent/:htmlContentId route
     ...
     */
        ...
        .patch( tokenAuthMiddleware.authenticate, htmlModuleController.patchHtmlContent )
        ...
        .put( tokenAuthMiddleware.authenticate, htmlModuleController.updateHtmlContent );
