 ...
 *     }
         *
         */
        .post( tokenAuthMiddleware.authenticate, uploader.single('imageName'), fileUploadHelper.imageUpload,  eventManagementController.postEvent );
 ...
 *     }
         *
         */
        .patch( tokenAuthMiddleware.authenticate, eventManagementController.patchEvent )
 ...
 *     }
         *
         */
        .put( tokenAuthMiddleware.authenticate, uploader.single('imageName'), fileUploadHelper.imageUpload, eventManagementController.updateEvent );
