...
var textEditorFileRoute = function () {
     ...
     */
        ...
        .get(tokenAuthMiddleware.authenticate, getAllFiles)
        ...
        .post(tokenAuthMiddleware.authenticate, uploader.single('image'), fileUploadHelper.imageUpload, textEditorController.saveFile)
        ...
        .delete(tokenAuthMiddleware.authenticate, textEditorController.deleteFile);


    //for managing directory of tiny mce text editor
    textEditorRouter.get('/dir', tokenAuthMiddleware.authenticate, function (req, res) {
