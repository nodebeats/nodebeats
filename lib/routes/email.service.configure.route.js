 ...
 *     }
     ...
     */
        ...
        .get( tokenAuthMiddleware.authenticate, getMailServiceConfig )
 ...
 *       }
         ...
         *
         */
        .post( tokenAuthMiddleware.authenticate, emailServiceController.postMailServiceConfig );
    ...
    mailServiceRouter.use('/:mailServiceConfigId', tokenAuthMiddleware.authenticate, function(req, res, next){
 ...
 *       }
         ...
         *
         */
        .put( tokenAuthMiddleware.authenticate, emailServiceController.updateMailService );
