...
var testimonialRoutes = function(){
     ...
     */
         ...
         *
         */
        .post( tokenAuthMiddleware.authenticate, uploader.single('imageName'), fileUploadHelper.imageUpload, testimonialController.postTestimonial );
     ...
     *     }
         ...
         *
         */
        .patch( tokenAuthMiddleware.authenticate, testimonialController.patchTestimonial )
     ...
     *     }
         ...
         *
         */
        .put( tokenAuthMiddleware.authenticate, uploader.single('imageName'), fileUploadHelper.imageUpload, testimonialController.updateTestimonial );
