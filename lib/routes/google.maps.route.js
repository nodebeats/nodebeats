...
var googleMapsRoutes = function(){
    ...
    *       }
     ...
     */
         ...
         *
         */
        .post( tokenAuthMiddleware.authenticate, googleMapsController.postGoogleMapsConfig );



    //middleware function that will get the google maps configuration setting object for each of the routes defined downwards
    googleMapsRouter.use('/:googleMapsConfigId', tokenAuthMiddleware.authenticate,  function(req, res, next){
 ...
 *     }
         *
         */
        .put( tokenAuthMiddleware.authenticate, googleMapsController.updateGoogleMapsConfig );
