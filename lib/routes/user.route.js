...
var userRoutes = function () {
     ...
     */
        ...
        .get(tokenAuthMiddleware.authenticate, getUsers)
        ...
        .post(tokenAuthMiddleware.authenticate, uploader.single('avatar'), fileUploadHelper.imageUpload, userController.saveUsers);
    ...
    userRouter.use('/user/:userId', tokenAuthMiddleware.authenticate, function (req, res, next) {
     ...
     */
        ...
        .patch(tokenAuthMiddleware.authenticate, userController.patchUserInformation)
        ...
        .put(tokenAuthMiddleware.authenticate, uploader.single('avatar'), fileUploadHelper.imageUpload, userController.updateUser);
    ...
    userRouter.route('/change-password/confirm/:userId')

    /**
     * @api {patch} /api/change-password/confirm/:userId  Updates  user's password information to the  database
