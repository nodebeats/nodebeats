...
var teamMemberRoutes = function () {
     ...
     */
         ...
         *
         */
        .post( tokenAuthMiddleware.authenticate, uploader.single('imageName'), fileUploadHelper.imageUpload, teamMemberController.postTeamMemberInfo );
     ...
     *     }
         ...
         *
         */
        .patch(tokenAuthMiddleware.authenticate, teamMemberController.patchTeamMemberInfo)
     ...
     *     }
         ...
         *
         */
        .put(tokenAuthMiddleware.authenticate, uploader.single('imageName'), fileUploadHelper.imageUpload, teamMemberController.updateTeamMemberInfo);
     ...
     */
        ...
        .patch( tokenAuthMiddleware.authenticate, teamMemberController.updateTeamMemberHierarchy );
