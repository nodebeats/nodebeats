...
var teamMemberRoutes = (function () {
     ...
     */
         ...
         *
         */
        .post( tokenAuthMiddleware.authenticate, roleAuthMiddleware.authorize, roleAuthMiddleware.authorize, uploader.single('imageName'), fileUploadHelper.imageUpload, teamMemberController.postTeamMemberInfo );
