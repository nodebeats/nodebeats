...
var blogRoutes = function () {
     ...
     */
        ...
        .post(tokenAuthMiddleware.authenticate, blogController.postBlogCategory);
     ...
     */
        ...
        .patch(tokenAuthMiddleware.authenticate, blogController.patchBlogCategory)
        ...
        .put(tokenAuthMiddleware.authenticate, blogController.updateBlogCategory);
     ...
     */
        ...
        .post(tokenAuthMiddleware.authenticate, uploader.single('imageName'), fileUploadHelper.imageUpload, blogController.postBlogArticle );
     ...
     */
        ...
        .patch(tokenAuthMiddleware.authenticate, blogController.deleteBlog)
        ...
        .put(tokenAuthMiddleware.authenticate, uploader.single('imageName'), fileUploadHelper.imageUpload, blogController.updateBlog);
     ...
     */
        ...
        .put(tokenAuthMiddleware.authenticate,  blogController.updateBlogSeoMetaTag);
     ...
     */
        ...
        .post(tokenAuthMiddleware.authenticate, documentUploader.single('documentName'), blogController.postBlogRelatedDocument );
     ...
     */
        ...
        .patch(tokenAuthMiddleware.authenticate, blogController.deleteBlogDocumentInfo)
     ...
     *       "documentId": "578fbe3c29d4b80333a535df"
        ...
        .put(tokenAuthMiddleware.authenticate, documentUploader.single('documentName'),  blogController.updateBlogDocumentInfo);
