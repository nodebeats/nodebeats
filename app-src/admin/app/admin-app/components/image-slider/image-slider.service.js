...
var ImageSliderService = (function () {
    function ImageSliderService(_http, fileService) {
        var _this = this;
        this._http = _http;
        this.fileService = fileService;
        this.apiRoute = "imageslider";
        this.progress = Observable_1.Observable.create(function (observer) {
            _this.progressObserver = observer;
        }).share();
    }
    ImageSliderService.prototype.deleteImage = function (fileName, orgExt, path) {
        return this.fileService.deleteFile(fileName, orgExt, path, "image");
    };
    ImageSliderService.prototype.saveImageSlider = function (objSave, file) {
        var _this = this;
    ...
    ImageSliderService.prototype.updateImageSlider = function (objUpdate, file, imageDeleted) {
        var _this = this;
        return Observable_1.Observable.create(function (observer) {
            var formData = new FormData(), xhr = new XMLHttpRequest();
            if (file) {
