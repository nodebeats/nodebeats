...
var HtmlContentService = (function () {
    function HtmlContentService(_http) {
        this._http = _http;
        this.apiRoute = "htmlcontent";
    }
    HtmlContentService.prototype.saveHtmlEditor = function (objSave) {
        var body = JSON.stringify(objSave);
        return this._http.post(env_config_1.API_URL + this.apiRoute, body)
            .map(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    HtmlContentService.prototype.updateHtmlEditor = function (objUpdate) {
        var body = JSON.stringify(objUpdate);
        return this._http.put(env_config_1.API_URL + this.apiRoute + "/" + objUpdate._id, body)
            .map(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    HtmlContentService.prototype.deleteHtmlEditor = function (objUpdate) {
    ...
    HtmlContentService.prototype.getHtmlEditorList = function (perPage, currentPage) {
        return this._http.get(env_config_1.API_URL + this.apiRoute + "?perpage=" + perPage + "&page=" + currentPage)
            .map(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    HtmlContentService.prototype.getHtmlEditorById = function (id) {
        return this._http.get(env_config_1.API_URL + this.apiRoute + "/" + id)
            .map(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    HtmlContentService.prototype.handleError = function (error) {
        console.log(error.json());
        return Observable_1.Observable.throw(error.json() || 'server error');
    };
    HtmlContentService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [http_1.Http])
    ], HtmlContentService);
    return HtmlContentService;
}());
exports.HtmlContentService = HtmlContentService;
//# sourceMappingURL=html-content.service.js.map