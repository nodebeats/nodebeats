...
var ContactService = (function () {
    function ContactService(_http) {
        this._http = _http;
        this.apiRoute = "contact/info";
    }
    ContactService.prototype.getContactList = function (perPage, currentPage) {
    ...
    ContactService.prototype.deleteContact = function (objUpdate) {
