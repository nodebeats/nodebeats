...
var OrganizationInfoService = (function () {
    /* End Image Upload */
    function OrganizationInfoService(_http, fileService) {
        this._http = _http;
        this.fileService = fileService;
        this.apiRoute = "organization/info";
    }
    OrganizationInfoService.prototype.saveOrgInfo = function (objSave, file) {
        var _this = this;
    ...
    OrganizationInfoService.prototype.getCountryList = function () {
        return this._http.get(env_config_1.API_URL + this.apiRoute)
            .map(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    OrganizationInfoService.prototype.updateOrgInfo = function (objUpdate, file, imageDeleted) {
        var _this = this;
    ...
    OrganizationInfoService.prototype.getOrgInfoDetail = function () {
        return this._http.get(env_config_1.API_URL + this.apiRoute)
            .map(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    OrganizationInfoService.prototype.deleteImage = function (fileName, orgExt, path) {
        return this.fileService.deleteFile(fileName, orgExt, path, "image");
    };
    OrganizationInfoService.prototype.handleError = function (error) {
        console.log(error.json());
        return Observable_1.Observable.throw(error.json() || 'server error');
    };
    OrganizationInfoService = __decorate([
        core_1.Injectable(), 
...
exports.OrganizationInfoService = OrganizationInfoService;
