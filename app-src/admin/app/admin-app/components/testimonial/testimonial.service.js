...
var TestimonialService = (function () {
    function TestimonialService(_http, fileService) {
        var _this = this;
        this._http = _http;
        this.fileService = fileService;
        this.apiRoute = "testimonial";
        this.progress = Observable_1.Observable.create(function (observer) {
            _this.progressObserver = observer;
        }).share();
    }
    TestimonialService.prototype.deleteImage = function (fileName, orgExt, path) {
        return this.fileService.deleteFile(fileName, orgExt, path, "image");
    };
    TestimonialService.prototype.saveTestimonial = function (objSave, file) {
        var _this = this;
    ...
    TestimonialService.prototype.updateTestimonial = function (objUpdate, file, imageDeleted) {
        var _this = this;
        return Observable_1.Observable.create(function (observer) {
            var formData = new FormData(), xhr = new XMLHttpRequest();
            if (file) {
    ...
    TestimonialService.prototype.getTestimonialDetail = function (testimonialId) {
        return this._http.get(env_config_1.API_URL + this.apiRoute + "/" + testimonialId)
            .map(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    TestimonialService.prototype.deleteTestimonial = function (objSlider) {
        var body = JSON.stringify(objSlider);
        return this._http.patch(env_config_1.API_URL + this.apiRoute + "/" + objSlider._id, body)
            .map(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    TestimonialService.prototype.handleError = function (error) {
