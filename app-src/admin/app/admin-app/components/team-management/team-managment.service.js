...
var TeamManagementService = (function () {
    function TeamManagementService(_http, fileService) {
        var _this = this;
        this._http = _http;
    ...
    TeamManagementService.prototype.deleteImage = function (fileName, orgExt, path) {
        return this.fileService.deleteFile(fileName, orgExt, path, "image");
    };
    TeamManagementService.prototype.saveTeamMember = function (objSave, file) {
        var _this = this;
    ...
    TeamManagementService.prototype.updateTeamMember = function (objUpdate, file, imageDeleted) {
        var _this = this;
        return Observable_1.Observable.create(function (observer) {
            var formData = new FormData(), xhr = new XMLHttpRequest();
            if (file) {
    ...
    TeamManagementService.prototype.getTeamMemberDetail = function (testimonialId) {
        return this._http.get(env_config_1.API_URL + this.apiRoute + "/" + testimonialId)
            .map(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    TeamManagementService.prototype.sortTeamOrder = function (memberId, order, sort) {
        var body = JSON.stringify({ sort: sort });
        return this._http.patch(env_config_1.API_URL + "member/hierarchy/" + memberId + "/" + order, body)
            .map(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    TeamManagementService.prototype.deleteTeamMember = function (objSlider) {
...
//# sourceMappingURL=team-managment.service.js.map