...
var ForgotPasswordService = (function () {
    function ForgotPasswordService(http) {
        this.http = http;
        this._forgotUrl = env_config_1.API_URL + '/change-password/verify'; // URL to web api
    }
    ForgotPasswordService.prototype.forgotPassword = function (objForgot) {
        var body = JSON.stringify(objForgot);
