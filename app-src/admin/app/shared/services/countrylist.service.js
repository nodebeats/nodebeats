...
var CountryListService = (function () {
    function CountryListService(_http) {
        this._http = _http;
        this.jsonFile = "country.json";
    }
    CountryListService.prototype.getCountryList = function () {
        return this._http.get(env_config_1.JSON_URL + this.jsonFile)
            .map(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    CountryListService.prototype.handleError = function (error) {
